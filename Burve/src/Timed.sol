 ...
 * in Itos 2sAMM repo.
 * @notice Copied from the Itos Commons library.
 * @notice The Diamond storage location is DIFFERENT from the Commons library location.
 *
 */
...
library Timed {
    ...
    bytes32 constant TIMED_STORAGE_POSITION =
        keccak256("itos.burve.v0.timed.diamond.storage");
